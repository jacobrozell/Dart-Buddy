...
final class SuddenDeathMatchViewModel: ObservableObject {
    ...
    func loadSessionIfNeeded() async {
        ...
        switch await MatchSessionLoader.load(
            ...
            sessionMissingFallbackKey: "suddenDeath.error.sessionMissing"
        ) {
...
extension SuddenDeathMatchViewModel: MatchPlaySessionHost {
    ...
    var hostMatchType: MatchType { .suddenDeath }
}
