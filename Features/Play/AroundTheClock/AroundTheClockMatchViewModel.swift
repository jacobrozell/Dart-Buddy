...
final class AroundTheClockMatchViewModel: ObservableObject {
    ...
    func loadSessionIfNeeded() async {
        ...
        switch await MatchSessionLoader.load(
            ...
            sessionMissingFallbackKey: "aroundTheClock.error.sessionMissing"
        ) {
...
extension AroundTheClockMatchViewModel: MatchPlaySessionHost {
    ...
    var hostMatchType: MatchType { .aroundTheClock }
}
