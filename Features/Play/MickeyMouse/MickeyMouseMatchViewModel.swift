...
final class MickeyMouseMatchViewModel: ObservableObject {
    ...
    func loadSessionIfNeeded() async {
        ...
        switch await MatchSessionLoader.load(
            ...
            sessionMissingFallbackKey: "mickeyMouse.error.sessionMissing"
        ) {
...
extension MickeyMouseMatchViewModel: MatchPlaySessionHost {
    ...
    var hostMatchType: MatchType { .mickeyMouse }
}
