...
**Status:** Planned (`practice.chaseTheDragon`).
...
- 3 darts per turn; first qualifying hit advances
...
### Turn flow
1. Validate dart against current step (treble N or bull type).
2. Advance on hit; complete at end of course × laps.
...
Three darts per turn. First qualifying hit moves you one step. Multiplayer: first to finish the full dragon wins.
...
## 7. Testing
- Unit: treble-only validation, bull order, multi-lap
