...
Local-first iOS app: X01 + Cricket, players, **Statistics**, history, settings, migration recovery, Release-only Firebase Analytics + Crashlytics (see `specs/FirebaseBackendAnalyticsSpec.md`).
