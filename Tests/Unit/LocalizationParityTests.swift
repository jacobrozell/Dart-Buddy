...
struct LocalizationParityTests {
    ...
    @Test("Localized strings share the same keys as English", arguments: ["de", "es", "nl", "it"])
    ...
    @Test("Format specifiers match per key between English and locale", arguments: ["de", "es", "nl", "it"])
