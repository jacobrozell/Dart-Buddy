...
| # | Gap | Phase |
|---|-----|-------|
| 1 | `party1_1` unlocks all party modes when `showsPartyModes` is true | 1.1 |
| 2 | Around the Clock blocked (`showsModesTab` for practice) | 1.1 |
| 3 | `Lean1_0SmokeUITests` expects 1.0 picker | 1.5 |
| 4 | CI does not run on `release/*` push by default | 2.1 |
| 5 | `estimated-releases.json` has ATC at `1.4` | 7 |
