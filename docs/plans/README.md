...
| Plan | Status | Summary |
|------|--------|---------|
| [`coop-mode-grouping.md`](coop-mode-grouping.md) | Phase 0 done · Raid not started | Co-op catalog section + platform spec; agent query for Learn rules or Raid ship |
