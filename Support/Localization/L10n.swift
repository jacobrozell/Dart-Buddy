...
enum L10n {
    ...
    static let csvSection: LocalizedStringKey = "settings.csv.section"
    static let csvFooter: LocalizedStringKey = "settings.csv.footer"
    static let csvImport: LocalizedStringKey = "settings.csv.import"
    static let csvTemplate: LocalizedStringKey = "settings.csv.template"
    static let migrationExportCSV: LocalizedStringKey = "migration.exportCSV"
