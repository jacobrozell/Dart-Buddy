...
enum L10n {
    ...
    static let botStatsSummarySection: LocalizedStringKey = "players.bots.stats.summary.section"
    static let botStatsSummaryHint: LocalizedStringKey = "players.bots.stats.summary.hint"
    static let botStatsEngineDetails: LocalizedStringKey = "players.bots.stats.engineDetails"
    static let presetBotCustomizeTitle: LocalizedStringKey = "presetBot.customize.title"
    static let presetBotCustomizeAction: LocalizedStringKey = "presetBot.customize.action"
    ...
    static let feedbackSummary: LocalizedStringKey = "feedback.summary"
    static let feedbackSummaryFooter: LocalizedStringKey = "feedback.summary.footer"
    static let feedbackDetailsTitle: LocalizedStringKey = "feedback.details.title"
    static let feedbackDetailsField: LocalizedStringKey = "feedback.details.field"
    static let feedbackSend: LocalizedStringKey = "feedback.send"
    static let feedbackSendFooter: LocalizedStringKey = "feedback.send.footer"
    static let feedbackMailUnavailableTitle: LocalizedStringKey = "feedback.mailUnavailable.title"
    static let feedbackMailUnavailableCopy: LocalizedStringKey = "feedback.mailUnavailable.copy"
    static let feedbackMailUnavailableOpenMail: LocalizedStringKey = "feedback.mailUnavailable.openMail"
